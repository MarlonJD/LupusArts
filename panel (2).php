...
<form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
  <p>
    <label for="textfield2">Link:</label>
    <input name="textfield2" type="text" id="textfield2" value="<?php echo basename( $_FILES["fileToUpload"]["name"]); ?>" readonly>
  </p>
  <p>
    <label for="textfield3">Title:</label>
    <input type="text" name="textfield3" id="textfield3">
  </p>
  <p>
    <label for="textfield4">Comment:</label>
  ...
  <p>
    <input type="submit" name="submit" id="submit" value="Sent">
  </p>
