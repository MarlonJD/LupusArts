...
if (isset($_POST['inputUser'])) {
  ...
  $LoginRS__query=sprintf("SELECT username, pass, rank FROM `user` WHERE username=%s AND pass=%s",
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form ACTION="<?php echo $loginFormAction; ?>" METHOD="POST" class="form-signin" id="1">
